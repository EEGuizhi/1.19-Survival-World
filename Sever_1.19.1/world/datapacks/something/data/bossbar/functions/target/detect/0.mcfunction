...
execute if score @s target_timesCt matches 81.. if score @s target matches 0 run bossbar set minecraft:plyr0 visible false
...
# 往前0.1格執行
execute if score @s target_timesCt matches 0..80 unless score @s target matches 1.. positioned ^ ^ ^0.1 run function bossbar:target/detect/0
